...
3. Start the stack: `make monitoring-up` in a clone, or on a server installed with install.sh the `docker compose -p railhook-monitoring` command in [Monitoring](/docs/self-hosting/monitoring/).
</Steps>
