...
Terms used across the docs, the API and the dashboard. The last column gives the dashboard's name where it differs.
...
| **Retry ladder** | How long to wait before each further attempt, and how many attempts there are before giving up. Outgoing: 7 attempts, waiting 1m, 5m, 15m, 1h, 6h, then 24h. Incoming: 5 attempts, waiting 1m, 5m, 15m, 1h. | — |
