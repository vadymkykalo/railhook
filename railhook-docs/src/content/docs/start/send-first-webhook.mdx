...
This page takes one event from your system to your customer's endpoint through the API, and shows the receiver how to prove the request came from you. You need a project ID and an API key with the `READ_WRITE` scope ([Quickstart](/docs/start/quickstart/) covers both).
...
<CardGrid>
  <LinkCard title="Signatures" description="Both signing schemes, secret rotation and Standard Webhooks." href="/docs/outgoing/signatures/" />
  <LinkCard title="Retries and failed messages" description="What happens while the endpoint is down." href="/docs/outgoing/retries/" />
  <LinkCard title="SDKs" description="Node.js, Python and PHP clients." href="/docs/tools/sdks/" />
</CardGrid>
