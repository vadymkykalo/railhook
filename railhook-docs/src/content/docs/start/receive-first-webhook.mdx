...
4. **Send a test and watch it arrive**
   ...
   Send a test webhook from the provider's dashboard. It shows up under **Incoming → Incoming events**, with one forward per destination. A forward that runs out of retries moves to **Failed forwards**.
