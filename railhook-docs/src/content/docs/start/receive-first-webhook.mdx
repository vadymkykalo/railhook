...
<Aside type="tip">
Self-hosting? Ingress URLs are built from `TUNNEL_INGRESS_BASE_URL`, which defaults to `http://localhost:8080`. Set it to your public URL, or providers will be handed an address they cannot reach. See [Configuration](/docs/self-hosting/configuration/).
</Aside>
