...
<Aside type="tip">
On a self-hosted instance, the public tunnel URL is built from `TUNNEL_INGRESS_BASE_URL`. Set it to the instance's public address, or the URL will point at `localhost`.
</Aside>
