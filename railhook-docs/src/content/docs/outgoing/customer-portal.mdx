...
<CardGrid>
  <LinkCard title="Endpoints and subscriptions" href="/docs/outgoing/endpoints-subscriptions/" description="What a Consumer registers, and how event types match." />
  <LinkCard title="Retries and failed deliveries" href="/docs/outgoing/retries/" description="The ladder a retried delivery walks again." />
  <LinkCard title="API reference" href="/docs/api-reference/" description="Every Consumers and Portal request and response." />
</CardGrid>
