...
A project decides what happens to an event sent without an `Idempotency-Key`, through its `idempotencyPolicy` setting. In the dashboard it is under **Settings → Project**.
