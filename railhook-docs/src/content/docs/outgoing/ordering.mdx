...
A delivery goes out only when everything ahead of it for that endpoint has succeeded or been given up on. A delivery that is abandoned to Failed deliveries stops blocking the ones behind it.
...
<CardGrid>
  <LinkCard title="Retries and failed deliveries" href="/docs/outgoing/retries/" description="How a failing delivery ends, and stops blocking." />
  <LinkCard title="Replay" href="/docs/outgoing/replay/" description="Why a replayed delivery gets a new position." />
