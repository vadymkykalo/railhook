...
<CardGrid>
  <LinkCard title="Endpoints and subscriptions" href="/docs/outgoing/endpoints-subscriptions/" description="Event type patterns and what a subscription matches." />
  <LinkCard title="Errors and limits" href="/docs/platform/errors-limits/" description="What a rejected event looks like to the sender." />
  <LinkCard title="API reference" href="/docs/api-reference/" description="Every schema registry request and response." />
</CardGrid>
