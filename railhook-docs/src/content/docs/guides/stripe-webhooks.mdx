...
5. **Send a test event** from Stripe, or run `stripe trigger payment_intent.succeeded`. It appears under **Events → Incoming events**, with one forward per destination.
