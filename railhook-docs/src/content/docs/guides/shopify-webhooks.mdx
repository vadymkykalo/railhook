...
4. **Send a test:**
   ...
   It appears under **Events → Incoming events**, with one forward per destination.
...
<CardGrid>
  ...
  <LinkCard title="Transformations" href="/docs/outgoing/transformations/" description="Reshape a forwarded body before your service sees it." />
</CardGrid>
