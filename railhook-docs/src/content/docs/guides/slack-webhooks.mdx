...
5. **Subscribe to bot events**, save, and trigger one, such as a message in a channel the app is in. It appears under **Events → Incoming events**, with one forward per destination.
