...
Hookdeck is two products: Event Gateway for receiving webhooks and Outpost for sending them. Railhook does both in one product, so it is compared with each half.
