...
4. **Compare.** Watch `delivery_oldest_pending_age_seconds` and failed messages in Railhook against the old platform's numbers. See [Observability](/docs/platform/observability/).
...
Check [How Railhook compares](/docs/resources/comparison/) for what Railhook does not have yet, such as a customer-facing portal, SSO and non-HTTP destinations.
