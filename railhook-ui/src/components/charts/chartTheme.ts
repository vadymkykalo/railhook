 ...
 * product has: ink (--primary). That is deliberate, not a shortage. A nominal
 ...
 * every neighbour *and* the 2:1 light-end floor in both modes. Ink on white
 * and white on near-black both clear it by a wide margin.
 */
