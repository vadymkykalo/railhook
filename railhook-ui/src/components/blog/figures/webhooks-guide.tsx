...
/** Wire data (headers, ids, signatures) are constants, not keys: a translator must not change them. */

/** Two figures on one page must not share a marker id. */
...
/** Elbow leaders: three annotated lines are adjacent, and pinned callouts would stack. */
